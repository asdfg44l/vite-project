...
declare global {
  ...
  const useDialogsStore: typeof import('@/store/index')['useDialogsStore']
  ...
  const useProfileStore: typeof import('@/store/index')['useProfileStore']
  ...
  const useUIStore: typeof import('@/store/index')['useUIStore']
